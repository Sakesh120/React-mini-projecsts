...
const FailedTask = ({ data }) => {
  return (
    <div className="flex-shrink-0 h-[220px] w-full sm:w-[250px] lg:w-[300px] p-4 sm:p-5 bg-gray-400 rounded-xl">
      {/* Header */}
      ...
      {/* Button */}
      <div className="mt-5">
        <button className="w-full bg-red-500 py-2 px-3 text-xs sm:text-sm text-white rounded-sm cursor-pointer hover:bg-red-600 transition">
          Failed
        </button>
      </div>
    </div>
