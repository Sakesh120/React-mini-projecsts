    ...
    <motion.div
      ...
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        <motion.div
          ...
          <p className='max-w-md'>From strategy to execution, we craft digtal solutions that move your business forward.</p>
        ...
        <motion.div
          ...
          <div className='flex gap-2 text-sm'>
            ...
            <button className='bg-red-500 text-white rounded px-6 flec items-center font-bold cursor-pointer hover:scale-103'>Subscribe</button>
      ...
      <motion.div
        ...
        <p>Copyright 2025 &copy; agency.io GreatStack - All Right Reserved.</p>
