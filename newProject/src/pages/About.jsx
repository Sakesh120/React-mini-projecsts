  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20">
      <div className="max-w-5xl mx-auto bg-white rounde-2xl shadow-lg p-8 space-y-8 ">
        <h1 className="text-4xl font-bold text-center">About Sansktrity</h1>
        <p className="text-gray-700 text-lg">
          Welcome to{" "}
          <span className="font-semibold text-red-600">Sansktrity</span>, your
          one-stop destination for the latest and greatest in market. From
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-base">
            At Sansktrity, our mission is to make innovation technology
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-base">
            ...
            Sansktrity, we're comitted to staying ahead of the curve, offrering
        ...
        <div className="text-center mt-10">
          <h3 className="text-xl font-semibold text-red-600  mb-2 ">
            Join the Sansktrity family
          </h3>
          <p className="text-gray-700 mb-4">
            Whether you're a tech enthusist, a proffetional, or just looking for
            something cool and functional- Sansktrity has something for everyone
          </p>
          <Link to={"/products"}>
